...
import { Download, Map, Trophy, Users, BookOpen, Video, HelpCircle, Shield, Swords, Calendar, Gamepad2, Heart } from "lucide-react"
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              A melhor experiencia Pokemon online. Junte-se a milhares de treinadores e comece sua jornada.
            </p>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t-2 border-border pt-8 sm:flex-row">
          <p className="flex items-center gap-1 text-sm text-muted-foreground">
            2026 PokeWorld. Feito com <Heart className="h-4 w-4 text-pokemon-red" /> para treinadores.
          </p>
          <div className="flex gap-6">
            <Link href="/termos" className="text-sm font-medium text-muted-foreground transition-colors hover:text-foreground">
              Termos de Uso
            </Link>
            <Link href="/privacidade" className="text-sm font-medium text-muted-foreground transition-colors hover:text-foreground">
              Privacidade
            </Link>
          </div>
        </div>
