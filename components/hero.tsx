...
import { Download, Play, Users, Trophy, Calendar, Sparkles, Zap } from "lucide-react"

// Dados de exemplo - na versao real viram do PHP
const stats = [
  { label: "Jogadores Online", value: "2,847", icon: Users, color: "text-pokemon-blue" },
  { label: "Torneios Realizados", value: "1,254", icon: Trophy, color: "text-pokemon-yellow" },
  { label: "Eventos Ativos", value: "12", icon: Calendar, color: "text-pokemon-green" },
]
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="text-center">
          ...
          <h1 className="text-balance text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
            ...
            <span className="mt-2 block bg-gradient-to-r from-primary via-pokemon-blue to-pokemon-purple bg-clip-text text-transparent">
              Pokemon Online
            </span>
          </h1>
          ...
          <p className="mx-auto mt-6 max-w-2xl text-pretty text-lg text-muted-foreground">
            Junte-se a milhares de treinadores em uma aventura epica. Capture, treine e batalhe 
            com seus Pokemon favoritos em um mundo vasto e cheio de desafios.
          </p>

          {/* CTA Buttons */}
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link href="/download">
              <Button size="lg" className="gap-2 px-8 text-base font-semibold shadow-lg shadow-primary/30 transition-all hover:shadow-xl hover:shadow-primary/40">
                <Download className="h-5 w-5" />
                Baixar Jogo Gratis
              </Button>
            </Link>
            <Link href="/como-jogar">
              <Button size="lg" variant="outline" className="gap-2 border-2 px-8 text-base font-semibold bg-transparent hover:bg-secondary">
          ...
          <div className="mx-auto mt-16 max-w-lg">
            <div className="rounded-2xl border-2 border-primary/20 bg-card p-6 shadow-xl shadow-primary/10">
              ...
              <div className="grid grid-cols-4 gap-3">
                {[
                  { label: "Dias", value: countdown.days, color: "from-pokemon-red to-pokemon-orange" },
                  { label: "Horas", value: countdown.hours, color: "from-pokemon-blue to-primary" },
                  { label: "Min", value: countdown.minutes, color: "from-pokemon-green to-pokemon-blue" },
                  { label: "Seg", value: countdown.seconds, color: "from-pokemon-purple to-pokemon-red" },
                ].map((item) => (
                  <div key={item.label} className="text-center">
                    <div className={`rounded-xl bg-gradient-to-br ${item.color} p-0.5 shadow-lg`}>
              ...
              <Link href="/eventos" className="mt-4 block">
                <Button variant="ghost" className="w-full font-semibold text-primary hover:bg-primary/10 hover:text-primary">
