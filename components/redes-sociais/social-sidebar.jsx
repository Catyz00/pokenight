...
export default function SocialSidebar() {
  return (
    <div className="fixed left-4 top-1/2 z-40 hidden -translate-y-1/2 flex-col gap-3 lg:flex">
      ...
      <a
        href="/parceiros"
        className="group relative flex h-12 w-12 items-center justify-center rounded-lg bg-red-600/80 backdrop-blur-sm border-2 border-red-600 transition-all hover:w-auto hover:pl-3 hover:pr-4 hover:bg-red-700 hover:border-red-700 hover:scale-110 animate-pulse"
        aria-label="Ao Vivo"
      >
        <div className="flex items-center gap-2">
          ...
          <span className="hidden whitespace-nowrap text-sm font-bold text-white group-hover:inline">
            Ao Vivo
          </span>
        </div>
      </a>
